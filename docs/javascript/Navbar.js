        ...
        <nav class="mx-auto max-w-7xl px-6">
            <div class="flex h-16 items-center justify-between">
                ...
                <a href="index.html" class="inline-flex items-center gap-3">
                    <span
                        class="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-emerald-500/15 text-emerald-300">
                ...
                <div class="hidden items-center gap-2 lg:flex">
                    <a href="#services"
                        class="rounded-xl px-4 py-2 text-sm font-semibold text-white/75 transition hover:bg-white/5 hover:text-white">Programs</a>
                    <a href="#how-it-works"
                        class="rounded-xl px-4 py-2 text-sm font-semibold text-white/75 transition hover:bg-white/5 hover:text-white">How
                        it works</a>
                    <a href="#testimonials"
                        class="rounded-xl px-4 py-2 text-sm font-semibold text-white/75 transition hover:bg-white/5 hover:text-white">Reviews</a>
                    <a href="#faq"
                        class="rounded-xl px-4 py-2 text-sm font-semibold text-white/75 transition hover:bg-white/5 hover:text-white">FAQ</a>
        ...
        <div id="mobileNav"
            ...
            <div class="mx-auto max-w-7xl px-6 py-4">
                <div class="grid gap-2">
                    <a href="#services"
                        class="rounded-xl px-4 py-3 text-sm font-semibold text-white/80 transition hover:bg-white/5 hover:text-white">
                        <i class="fa-solid fa-dumbbell mr-2 text-emerald-300"></i>Programs
                    </a>
                    <a href="#how-it-works"
                        class="rounded-xl px-4 py-3 text-sm font-semibold text-white/80 transition hover:bg-white/5 hover:text-white">
                        <i class="fa-solid fa-list-check mr-2 text-emerald-300"></i>How it works
                    </a>
                    <a href="#testimonials"
                        class="rounded-xl px-4 py-3 text-sm font-semibold text-white/80 transition hover:bg-white/5 hover:text-white">
                        <i class="fa-solid fa-quote-left mr-2 text-emerald-300"></i>Reviews
                    </a>
                    <a href="#faq"
                        class="rounded-xl px-4 py-3 text-sm font-semibold text-white/80 transition hover:bg-white/5 hover:text-white">
                        <i class="fa-solid fa-circle-question mr-2 text-emerald-300"></i>FAQ
                    </a>
                    <a href="#contact"
